...
@Component({
  ...
  template: `
    <div [class]="'cv-modern cv-spacing-' + (resolvedResume().spacingMode || 'normal')" id="cv-modern" spellcheck="false" [style.--cv-primary]="resolvedResume().colorTheme || '#4f46e5'" [style.font-family]="resolvedResume().fontFamily || 'Inter, sans-serif'">
      <!-- Sidebar -->
